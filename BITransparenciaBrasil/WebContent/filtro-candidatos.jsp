      ...
      <section class="features" id="tecnologia">
        <div class="container">
          <div class="row">
                  ...
                  <strong>Selecione o cargo</strong><br><br>
                  </h1>
                  <!--<p style="margin-bottom:40px;">Aqui você irá selecionar o estado aonde você realiza o seu voto. Caso você esteja em trânsito (votando de outro estado), selecione o seu estado de origem.</p>-->  
            	</div>
           		<div class="col-md-12" align="center">
                      ...
                      <div class="row demo-tiles">
                        <div class="col-xs-3">
                          <div class="tile">
                          	<a href="resultado-dos-candidatos.jsp?estado=0&cargo=1"><img src="img/cargo-01b.jpg" alt="Compas" class="tile-image big-illustration"></a>
                             <h3 class="tile-title">Presidente</h3>
                          </div>
                        </div>
                
                        <div class="col-xs-3">
                          <div class="tile">
                            <a href="projeto.jsp?cargo=3"><img src="img/cargo-02b.jpg" alt="Compas" class="tile-image big-illustration"></a>
                            <h3 class="tile-title">Governador</h3>
                          </div>
                        </div>
                
                        <div class="col-xs-3">
                          <div class="tile">
                            <a href="projeto.jsp?cargo=5"><img src="img/cargo-03b.jpg" alt="Compas" class="tile-image big-illustration"></a>
                            <h3 class="tile-title">Senador</h3>
                          </div>
                        </div>
                
                        <div class="col-xs-3">
                          <div class="tile tile-hot">
                            <a href="projeto.jsp?cargo=6,7,8"><img src="img/cargo-04b.jpg" alt="Compas" class="tile-image big-illustration"></a>
                            <h3 class="tile-title">Deputados</h3>
                          </div>
